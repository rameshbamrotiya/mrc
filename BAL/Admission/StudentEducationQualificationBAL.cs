...
{
    public class StudentEducationQualificationBAL : StudentEducationQualificationDAL, IDisposable
    {
        ...
        public bool InsertOrUpdateData(StudentEducationQualificationBO objbo)
        {
            bool ret = false;
            try
            {
