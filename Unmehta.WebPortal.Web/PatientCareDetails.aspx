<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PatientCareDetails.aspx.cs" Inherits="Unmehta.WebPortal.Web.PatientCareDetails" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    UnMehta - Patient Care Details
</asp:Content>
                    ...
                    <div class="sidebar">
                        <div class="card widget-categories">
                            <div class="card-header">
                                <h4 class="card-title">Patient Care</h4>
                            </div>
                            <div class="card-body">
