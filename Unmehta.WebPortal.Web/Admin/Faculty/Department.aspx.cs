...
namespace Unmehta.WebPortal.Web.Admin.Faculty
{
    public partial class Department : System.Web.UI.Page
    {
        ...
        private bool LoadControlsAdd(DepartmentGridModels objBo)
        {
            ...
            if (!string.IsNullOrEmpty(txtDepartmentName.Text))
                objBo.DepartmentName = txtDepartmentName.Text;            
        ...
        protected void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            {
                DepartmentGridModels objBO = new DepartmentGridModels();                
                if (LoadControlsAdd(objBO))
                {
                    if (!objDepartmentRepository.InsertOrUpdateTblDepartment(objBO, out errorMessage))
                    {
        ...
        protected void ibtn_Edit_Click(object sender, EventArgs e)
        {
            ...
            txtDepartmentName.Text = grdUser.Rows[rowindex].Cells[1].Text.Trim();
        ...
        protected void ibtn_Delete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (IDepartmentRepository objDepartmentRepository = new DepartmentRepository(Functions.strSqlConnectionString))
                {
                    objDepartmentRepository.RemoveTblDepartment(rowId, out errorMessage);
                    ClearControlValues();
                    BindGridView();
                    Functions.MessagePopup(this, errorMessage, PopupMessageType.success);
                }
