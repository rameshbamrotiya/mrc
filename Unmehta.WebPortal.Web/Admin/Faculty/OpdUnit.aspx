<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OpdUnit.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.Faculty.OpdUnit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
      <title>CMS | OPD Unit</title>
</asp:Content>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtUnitName" aria-describedby="emailHelp" CssClass="form-control" placeholder="Enter Unit name" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvUnitName" ForeColor="Red" runat="server" ControlToValidate="txtUnitName"
                        ...
                        <div class="form-group">
                            <asp:GridView ID="grdUser" runat="server" AutoGenerateColumns="False" DataKeyNames="Id,LanguageId" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="UnitName" HeaderText="Unit Name" SortExpression="RoleName" />
                            ...
                            <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                SelectCommand="[GetAllOpdUnitMaster]" SelectCommandType="StoredProcedure" FilterExpression="UnitName like '%{0}%' ">
                                <FilterParameters>
