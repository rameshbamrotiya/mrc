<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Department.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.Faculty.Department" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>CMS | Department</title>
</asp:Content>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtDepartmentName" aria-describedby="emailHelp" CssClass="form-control" placeholder="Enter department name" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvDepartmentName" ForeColor="Red" runat="server" ControlToValidate="txtDepartmentName"
                                ErrorMessage="Enter department name." SetFocusOnError="true"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <label>&nbsp;</label>
                        ...
                        <div class="form-group">
                            <asp:GridView ID="grdUser" runat="server" AutoGenerateColumns="False" DataKeyNames="Id,LanguageId" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="DepartmentName" HeaderText="Department Name" SortExpression="RoleName" />
                            ...
                            <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                SelectCommand="[GetAllDepartmentMaster]" SelectCommandType="StoredProcedure" FilterExpression="DepartmentName like '%{0}%' ">
                                <FilterParameters>
