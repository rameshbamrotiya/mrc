...
function GetEditData(Data) {
    ...
    document.getElementById("bodyPart_txtFacultyName").value = strData[2];
    document.getElementById("bodyPart_ddlDesignation").value = strData[3];
    document.getElementById("bodyPart_ddlDepartment").value = strData[4];
...
function RemoveData(id) {
    if (confirm("Are you sure want to delete ? ")) {
        var urlS = "/Admin/Faculty/Faculty.aspx/RemoveDetailById";
        $.ajax({
            type: "POST",
            url: urlS,
            data: "{'id':'" + id + "'}",
...
function GetGriDData() {
    $.ajax({
        type: "POST",
        url: "/Admin/Faculty/Faculty.aspx/GetGridView",
        //data: "{'id':'1'}",
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (data) {
