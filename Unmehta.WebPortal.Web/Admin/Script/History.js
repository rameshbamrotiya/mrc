...
function GetEditData(Data) {
    ...
    document.getElementById("bodyPart_ddlHistoryYear").value = strData[2];
    document.getElementById("bodyPart_txtHistoryTitle").value = strData[3];
    document.getElementById("bodyPart_txtHistoryDescription").value = strData[4];
...
function RemoveData(id) {
    if (confirm("Are you sure want to delete ? ")) {
        var urlS = "/Admin/Hospital/History.aspx/RemoveDetailById";
        $.ajax({
            type: "POST",
            url: urlS,
            data: "{'id':'" + id + "'}",
...
function GetGriDData() {
    $.ajax({
        type: "POST",
        url: "/Admin/Hospital/History.aspx/GetGridView",
        //data: "{'id':'1'}",
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (data) {
