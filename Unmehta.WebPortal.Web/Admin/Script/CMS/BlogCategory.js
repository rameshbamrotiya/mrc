...
function GetEditData(Data) {
    ...
    document.getElementById("bodyPart_txtBlogName").value = strData[2];
    document.getElementById("bodyPart_txtShortDescription").value = strData[3];
    document.getElementById("bodyPart_txtDescription").value = strData[4];
...
function RemoveData(id) {
    if (confirm("Are you sure want to delete ? ")) {
        var urlS = "/Admin/Hospital/BlogCategory.aspx/RemoveDetailById";
        $.ajax({
            type: "POST",
            url: urlS,
            data: "{'id':'" + id + "'}",
...
function GetGriDData() {
    $.ajax({
        type: "POST",
        url: "/Admin/Hospital/BlogCategory.aspx/GetGridView",
        //data: "{'id':'1'}",
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (data) {
