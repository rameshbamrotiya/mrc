<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="RecruitmentLanguageMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.Recruitment.RecruitmentLanguageMaster" %>
        ...
        <div class="container-fluid d-sm-flex justify-content-between">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Course Gallery</li>
                </ol>
            </nav>
        </div>
    </div>
                                    ...
                                    <div class="form-group">
                                        <asp:GridView ID="gView" runat="server" AutoGenerateColumns="False" DataKeyNames="id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Language_Name" HeaderText="Language Name" SortExpression="Language_Name" />
                                                    ...
                                                    <ItemTemplate>
                                                        <div class="btn-group">
                                                            ...
                                                            <% if (SessionWrapper.UserPageDetails.CanDelete)
                                                                { %>
                                                            <asp:LinkButton ID="ibtn_Delete" ToolTip="Delete" CommandName="eDelete" OnClientClick='<%# Eval("Language_Name", "return confirm(\"Are you sure want to delete : {0} ? \")") %>' runat="server" SkinID="lDelete" data-original-title="Delete" CssClass="btn btn-sm btn-danger show-tooltip"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                            <%} %>
                                                        </div>
                                                    </ItemTemplate>
                                        ...
                                        <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                            SelectCommand="[PROC_RecruitmentLanguageMaster_Search]" SelectCommandType="StoredProcedure" FilterExpression="Language_Name like '%{0}%' ">
                                            <FilterParameters>
                                                <asp:ControlParameter ControlID="txtSearch" Name="Language_Name" />
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Language Name<span class="req-field">*</span></label>
                                        <asp:TextBox ID="txtLanguageName" TabIndex="1" MaxLength="50" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvlanName" CssClass="validationmsg" runat="server" ControlToValidate="txtLanguageName"
                                            ErrorMessage="Please enter language name." SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
