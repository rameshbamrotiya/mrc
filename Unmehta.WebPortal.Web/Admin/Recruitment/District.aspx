<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="District.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.Recruitment.District" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="footerJS" runat="server">
    <script src="<%=ResolveUrl("~/Admin/Script/Recruitment/District.js") %>"></script>
</asp:Content>
