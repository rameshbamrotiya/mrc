...
{
    public partial class RecruitmentLanguageMaster : System.Web.UI.Page
    {
        #region Page Load
        ...
        protected void gView_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if ((e.CommandName.Equals("eView")) || (e.CommandName.Equals("eEdit")) || (e.CommandName.Equals("eDelete")))
                {
                    ...
                    {
                        RecruitmentLanguageMasterBO objBo = new RecruitmentLanguageMasterBO();
                        objBo.id = bytID;
                        new RecruitmentLanguageMasterBAL().DeleteRecord(objBo);
                        BindGridView();
        ...
        private bool FillControls(Int32 iPkId)
        {
            ...
            DataSet ds = new RecruitmentLanguageMasterBAL().SelectRecord(objBo);
            ...
            if (dr["Language_Name"] != DBNull.Value)
                txtLanguageName.Text = dr["Language_Name"].ToString();
        ...
        private void LoadControls(RecruitmentLanguageMasterBO objBo)
        {
            if (!string.IsNullOrEmpty(txtLanguageName.Text))
                objBo.Language_Name = txtLanguageName.Text;
        ...
        protected void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                RecruitmentLanguageMasterBO objBo = new RecruitmentLanguageMasterBO();
                LoadControls(objBo);
                if (new RecruitmentLanguageMasterBAL().InsertRecord(objBo))
                {
        ...
        protected void btn_Update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (new RecruitmentLanguageMasterBAL().UpdateRecord(objBo))
                {
