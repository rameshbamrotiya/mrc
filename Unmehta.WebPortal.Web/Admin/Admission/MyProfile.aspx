<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admission/Student.Master" AutoEventWireup="true" CodeBehind="MyProfile.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admission.MyProfile" %>
    ...
    <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="exampleInputFile">Gender<span class="req-field">*</span></label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="exampleInputFile">Marital Status<span class="req-field">*</span></label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtBirthDate" runat="server" class="form-control" placeholder="BirthDate" ValidationGroup="Main"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvBirthDate" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ControlToValidate="txtBirthDate" ValidationGroup="Main"></asp:RequiredFieldValidator>
