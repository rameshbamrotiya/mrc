<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintApplication.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.Admission.PrintApplication" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnBack" runat="server" CssClass="btn btn-primary submit-btn" OnClick="btnBack_Click" Text="Back" />
