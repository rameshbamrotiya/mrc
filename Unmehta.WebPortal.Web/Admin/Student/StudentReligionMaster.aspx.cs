...
{
    public partial class StudentReligionMaster : System.Web.UI.Page
    {
        #region Page Load
        ...
        protected void gView_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if ((e.CommandName.Equals("eView")) || (e.CommandName.Equals("eEdit")) || (e.CommandName.Equals("eDelete")))
                {
                    ...
                    {
                        StudentReligionMasterBO objBo = new StudentReligionMasterBO();
                        objBo.Id = bytID;
                        objBo.user_id = Convert.ToInt32(SessionWrapper.UserDetails.Id);
                        new StudentReligionMasterBAL().DeleteRecord(objBo);
                        BindGridView();
        ...
        private bool FillControls(Int32 iPkId)
        {
            ...
            DataSet ds = new StudentReligionMasterBAL().SelectRecord(objBo);
            ...
            else
            {
                ...
                if (dr["Name"] != DBNull.Value)
                    txtReligionName.Text = Convert.ToString(dr["Name"]);
        ...
        private void LoadControls(StudentReligionMasterBO objBo)
        {
            objBo.Name = txtReligionName.Text;
        ...
        protected void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                StudentReligionMasterBO objBo = new StudentReligionMasterBO();
                LoadControls(objBo);
                if (new StudentReligionMasterBAL().InsertRecord(objBo))
                {
        ...
        protected void btn_Update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (new StudentReligionMasterBAL().UpdateRecord(objBo))
                {
