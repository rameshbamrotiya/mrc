<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EducationQualificationMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.Student.EducationQualificationMaster" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Education Qualification Master</title>
</asp:Content>
        ...
        <div class="container-fluid d-sm-flex justify-content-between">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Education Qualification</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Education Type<span class="req-field">*</span></label>
                                        <asp:DropDownList ID="ddlEducationType" CssClass="form-control" TabIndex="4" runat="server" Style="width: 100%">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Preference<span class="req-field">*</span></label>
                                        <asp:DropDownList ID="ddlPreference" CssClass="form-control" TabIndex="4" runat="server" Style="width: 100%">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvPreference" ForeColor="Red" CssClass="validationmsg" runat="server" ControlToValidate="ddlPreference"
                                            ErrorMessage="Select preference." InitialValue="0" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
