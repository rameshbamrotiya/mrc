...
{
    public partial class CastMaster : System.Web.UI.Page
    {
        #region Page Load
        ...
        protected void gView_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if ((e.CommandName.Equals("eView")) || (e.CommandName.Equals("eEdit")) || (e.CommandName.Equals("eDelete")))
                {
                    ...
                    {
                        StudentCastMasterBO objBo = new StudentCastMasterBO();
                        objBo.Id = bytID;
                        objBo.user_id = Convert.ToInt32(SessionWrapper.UserDetails.Id);
                        new StudentCastMasterBAL().DeleteRecord(objBo);
                        BindGridView();
        ...
        private bool FillControls(Int32 iPkId)
        {
            ...
            DataSet ds = new StudentCastMasterBAL().SelectRecord(objBo);
            ...
            else
            {
                ...
                if (dr["Name"] != DBNull.Value)
                    txtCastName.Text = Convert.ToString(dr["Name"]);
        ...
        private void LoadControls(StudentCastMasterBO objBo)
        {
            objBo.Name = txtCastName.Text;
        ...
        protected void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                StudentCastMasterBO objBo = new StudentCastMasterBO();
                LoadControls(objBo);
                if (new StudentCastMasterBAL().InsertRecord(objBo))
                {
        ...
        protected void btn_Update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (new StudentCastMasterBAL().UpdateRecord(objBo))
                {
