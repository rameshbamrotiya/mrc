<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CastMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.Student.CastMaster" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>StudentCast Master</title>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="page_header" runat="server">
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
            <h4>StudentCast Master</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">CMS</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">StudentCast Master</li>
                </ol>
            </nav>
        </div>
    </div>
                                    ...
                                    <div class="form-group">
                                        <asp:GridView ID="gView" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Name" HeaderText="Cast Name" SortExpression="Name" />
                                        ...
                                        <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                            SelectCommand="[StudentCastMasterSearch]" SelectCommandType="StoredProcedure" FilterExpression="Name like '%{0}%' ">
                                            <FilterParameters>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Cast Name<span class="req-field">*</span></label>
                                        <asp:TextBox autocomplete="off" ID="txtCastName" TabIndex="1" MaxLength="50" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvCastname" CssClass="validationmsg" runat="server" ControlToValidate="txtCastName"
