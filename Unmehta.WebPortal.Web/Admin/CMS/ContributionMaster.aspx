<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ContributionMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.CMS.ContributionMaster" ValidateRequest="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="page_header" runat="server">
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
            <h4>Offline Contribution Master</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">CMS</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Contribution Master</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="exampleInputFile">Page Description<span class="req-field"></span></label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="exampleInputFile">Offline Description<span class="req-field"></span></label>
                            <asp:TextBox ID="txtOfflineDescription" runat="server" Rows="10" TextMode="MultiLine"></asp:TextBox>
                            <script type="text/javascript">
                                CKEDITOR.dtd.$removeEmpty['i'] = false;
                                var editor = CKEDITOR.replace('<%=txtOfflineDescription.ClientID%>');
                            </script>
                            <br />
                        </div>
                    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <asp:GridView ID="gvContribution" runat="server" AutoGenerateColumns="False" DataKeyNames="Id,Contribution_Id,Language_id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                AllowSorting="false" OnPageIndexChanging="gvContribution_PageIndexChanging" PageSize="10" AllowPaging="true">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="OfflineDonationDescription" HeaderText="Offline Description" />                                    
