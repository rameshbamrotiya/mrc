...
{
    public partial class PrivacyPolicyMaster : System.Web.UI.Page
    {
        ...
        private bool LoadControls(PrivacyPolicyMasterBO objBo)
        {
            ...
            {
                objBo.PPId = Convert.ToInt32(hfID.Value);
            }
        ...
        protected void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                LoadControls(objbo);
                if (new PrivacyPolicyMasterBAL().InsertRecord(objbo))
                {
                    FillControls(Convert.ToInt16(ddlLanguage.SelectedValue));
        ...
        private void FillControls(int LanguageId)
        {
            ...
            {
                PrivacyPolicyMasterBO objbo = new PrivacyPolicyMasterBO();
                PrivacyPolicyMasterBAL objBal = new PrivacyPolicyMasterBAL();
