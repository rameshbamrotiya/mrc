<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="FloorMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.CMS.FloorMaster" %>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">Floor Master</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Floor Master</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="rfvBlockName" CssClass="validationmsg" runat="server" ControlToValidate="txtFloorName"
                                ErrorMessage="Enter Floor Name" SetFocusOnError="true" ForeColor="Red"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" DataSourceID="sqlds" CssClass="table table-bordered table-hover table-striped" DataKeyNames="FloorId,Id,LanguageID" EmptyDataText="Record does not exist..."
                                AllowSorting="false" OnRowCommand="grdDetails_RowCommand" AllowPaging="true" OnPageIndexChanging="grdDetails_PageIndexChanging">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="FloorName" HeaderText="Floor Name" ItemStyle-Font-Bold="true" />
                                    <asp:TemplateField HeaderText="Sequencing">
                                        <ItemTemplate>
                                            <div class="btn-group">
                                                <asp:LinkButton ID="lnk_UP" CausesValidation="false" ToolTip="Page Up"
                                                    CommandArgument='<%# Eval("Id") + "," + Eval("Floor_level_id") + ","+ "up"%>' runat="server" data-original-title="Page Up" CssClass="btn btn-sm show-tooltip">
                                                            <i class="fa fa-arrow-circle-up"></i>
                                                </asp:LinkButton>

                                                <asp:LinkButton ID="lnk_Dwn" CausesValidation="false" ToolTip="Page Down"
                                                    CommandArgument='<%# Eval("Id") + "," + Eval("Floor_level_id") + "," +   "down" %>'
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            <div class="btn-group">
                                                ...
                                                <asp:LinkButton ID="ibtn_Delete" OnClick="ibtn_Delete_Click" ToolTip="Delete" CommandName="eDelete" OnClientClick='<%# Eval("FloorName", "return confirm(\"Are you sure want to delete : {0} ? \")") %>' runat="server" SkinID="lDelete" data-original-title="Delete" CssClass="btn btn-sm btn-danger show-tooltip"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
                            ...
                            <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                SelectCommand="[GetAllPatientCareFloorMasterDetails]" SelectCommandType="StoredProcedure" FilterExpression="FloorName like '%{0}%' ">
                                <FilterParameters>
