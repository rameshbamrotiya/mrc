<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.CMS.Category" ValidateRequest="false" %>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                   ...
                   <%-- <div class="col-md-3">
                        <label for="exampleInputFile">Scheme<span class="req-field">*</span></label>
                        <asp:DropDownList ID="drpScheme" CssClass="form-control" runat="server">
                        </asp:DropDownList>
                    </div>--%>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="exampleInputFile">Category Name<span class="req-field">*</span></label>
                        ...
                        <div class="form-group">
                            <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" DataSourceID="sqlds" CssClass="table table-bordered table-hover table-striped" DataKeyNames="CategoryID,Recid,LanguageID" EmptyDataText="Record does not exist..."
                                ...
                                <Columns>
                                    ...
                                    <%--<asp:BoundField DataField="SchemeName" HeaderText="Scheme" ItemStyle-Font-Bold="true" />--%>
                            ...
                            <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                SelectCommand="[GetAllCategory]" SelectCommandType="StoredProcedure" FilterExpression="Categoryname like '%{0}%' ">
                                <FilterParameters>
