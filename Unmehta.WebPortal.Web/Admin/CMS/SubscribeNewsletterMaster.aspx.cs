...
{
    public partial class SubscribeNewsletterMaster : System.Web.UI.Page
    {
        #region Page Load
        ...
        {
            SubscribeNewsletterMasterBAL objBAL = new SubscribeNewsletterMasterBAL();
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt.TableName = "SubscribeNewsletterDetails";
                using (XLWorkbook wb = new XLWorkbook())
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=SubscribeNewsletterMaster.xlsx");
