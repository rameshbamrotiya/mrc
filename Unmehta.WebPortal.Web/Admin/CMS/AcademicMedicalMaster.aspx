<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AcademicMedicalMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.CMS.AcademicMedicalMaster" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Academic Medical Master</title>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="page_header" runat="server">
    ...
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
            <h4>Academic Medical Master</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">CMS</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Academic Medical Master</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="txtAcademicsName">Academics Name<span class="req-field">*</span></label>
                            <asp:TextBox ID="txtAcademicsName" MaxLength="50" runat="server" CssClass="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvUserName" CssClass="validationmsg" runat="server" ControlToValidate="txtAcademicsName" ValidationGroup="main"
                                ErrorMessage="Enter Academics Name" SetFocusOnError="true"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="txtAcademicFullsName">Academics Full Name<span class="req-field">*</span></label>
                            <asp:TextBox ID="txtAcademicsFullName" MaxLength="50" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="txtShortDescription">Main Image</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="exampleInputFile">Student Name<span class="req-field">*</span></label>
                            <asp:TextBox ID="txtStudentName" MaxLength="50" runat="server" CssClass="form-control"></asp:TextBox>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlYear" CssClass="form-control" TabIndex="3" runat="server" Style="width: 100%">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="exampleInputFile">Student Photo Upload </label>
                            <asp:FileUpload ID="fuPhotoUpload" runat="server" accept=".png,.jpg,.jpeg,.gif"  CssClass="form-control" />
                            <asp:Label ID="lblPhoto" Width="100%" runat="server" Text="" Visible="false"></asp:Label>
                            <asp:HiddenField ID="hfPhoto" runat="server" />
                            <a  onclick="return RemoveImage('bodyPart_lblPhoto','bodyPart_aRemovePhoto','bodyPart_hfPhoto');" class="fa fa-trash-o btn btn-primary" id="aRemovePhoto" runat="server" style="margin-left:5px;">Remove</a>
                        </div>
                    </div>
                   <%-- <div class="col-md-12">
                        <div class="form-group">
                            <label for="txtDegreeHold">Degree<span class="req-field">*</span></label>
                            <asp:TextBox ID="txtDegreeHold" TextMode="MultiLine" Rows="4" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>--%>
                    <div class="col-md-3">
                        <br />
                            ...
                            <asp:GridView ID="gvDoctor" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="StudentName" ItemStyle-Width="100%" HeaderStyle-HorizontalAlign="Center"
                                        ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <%# HttpUtility.HtmlDecode( Eval("StudentName").ToString()) %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                ...
                <div class="col-md-3">
                    ...
                    <% if (SessionWrapper.UserPageDetails.CanUpdate)
                        { %>
                    <asp:Button runat="server" ID="btn_Update" CssClass="btn btn-primary " Text="Update" OnClick="btn_Update_ServerClick" ValidationGroup="main" />
                    <% }
                        ...
                        <div class="form-group">
                            <asp:GridView ID="grdUser" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="AcademicsName" HeaderText="Academics Name" SortExpression="AcademicsName" />
                                    <asp:BoundField DataField="AcademicsFullName" HeaderText="Academics Full Name" SortExpression="AcademicsFullName" />
                                    <asp:TemplateField HeaderText="View File">
                                        <ItemTemplate>
                                            <a id="afile" href='<%# string.IsNullOrWhiteSpace(Eval("ImagePath").ToString())? "": ResolveUrl(Eval("FilePath").ToString()) %>' target="_blank" runat="server" tooltip="View File"  class="fa fa-picture-o"></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>" SelectCommand="[GetAllAcademicMedicalMaster]" SelectCommandType="StoredProcedure"  FilterExpression="AcademicsName like '%{0}%' ">
                                 <FilterParameters>
