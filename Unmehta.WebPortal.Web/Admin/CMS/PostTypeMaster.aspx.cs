...
{
    public partial class PostTypeMaster : System.Web.UI.Page
    {
        #region Page Load
        ...
        protected void gView_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if ((e.CommandName.Equals("eView")) || (e.CommandName.Equals("eEdit")) || (e.CommandName.Equals("eDelete")))
                {
                    ...
                    {
                        PostTypeMasterBO objBo = new PostTypeMasterBO();
                        objBo.id = bytID;
                        new PostTypeMasterBAL().DeleteRecord(objBo);
                        BindGridView();
        ...
        private bool FillControls(Int32 iPkId)
        {
            ...
            DataSet ds = new PostTypeMasterBAL().SelectRecord(objBo);
            ...
            else
            {
                ...
                if (dr["Post_Name"] != DBNull.Value)
                    txtPostName.Text = Convert.ToString(dr["Post_Name"]);
        ...
        private void LoadControls(PostTypeMasterBO objBo)
        {
            objBo.Post_Name = txtPostName.Text;
        ...
        protected void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                PostTypeMasterBO objBo = new PostTypeMasterBO();
                LoadControls(objBo);
                if (new PostTypeMasterBAL().InsertRecord(objBo))
                {
        ...
        protected void btn_Update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (new PostTypeMasterBAL().UpdateRecord(objBo))
                {
