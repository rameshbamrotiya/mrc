<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="FeeTypeMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.CMS.FeeTypeMaster" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>FeeType Master</title>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="page_header" runat="server">
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
            <h4>FeeType Master</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">CMS</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">FeeType Master</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-left: 10px;">
                                    <div class="form-group">
                                        <asp:GridView ID="gView" runat="server" AutoGenerateColumns="False" DataKeyNames="Fee_id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Fee_type" HeaderText="Fee Type" SortExpression="Fee_type" />
                                                    ...
                                                    <ItemTemplate>
                                                        <div class="btn-group">
                                                            ...
                                                            <% if (SessionWrapper.UserPageDetails.CanDelete)
                                                                { %>
                                                            <asp:LinkButton ID="ibtn_Delete" ToolTip="Delete" CommandName="eDelete" OnClientClick='<%# Eval("Fee_type", "return confirm(\"Are you sure want to delete : {0} ? \")") %>' runat="server" SkinID="lDelete" data-original-title="Delete" CssClass="btn btn-sm btn-danger show-tooltip"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                            <%} %>
                                                        </div>
                                                    </ItemTemplate>
                                        ...
                                        <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                            SelectCommand="[PROC_FeetypeMasterdetails_Search]" SelectCommandType="StoredProcedure" FilterExpression="Fee_type like '%{0}%' ">
                                            <FilterParameters>
                                                <asp:ControlParameter ControlID="txtSearch" Name="Fee_type" />
                                            </FilterParameters>
                                        </asp:SqlDataSource>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Fee Type<span class="req-field">*</span></label>
                                        <asp:TextBox autocomplete="off" ID="txtFeetype" TabIndex="1" MaxLength="50" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvFeetype" CssClass="validationmsg" runat="server" ControlToValidate="txtFeetype"
                                            ErrorMessage="Please enter Fee Type." SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
