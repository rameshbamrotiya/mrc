<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EquipmentMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.CMS.EquipmentMaster" %>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-left: 10px;">
                                    <div class="form-group">
                                        <asp:GridView ID="gView" runat="server" AutoGenerateColumns="False" DataKeyNames="Equipment_id,Equipment_level_id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="Sr No." ItemStyle-Width="4%" HeaderStyle-HorizontalAlign="Center"
                                                 ...
                                                 <asp:BoundField DataField="Staffname" HeaderText="Staffname" SortExpression="EquipmentInfo" />
                                                <asp:BoundField DataField="Designation" HeaderText="Designation" SortExpression="EquipmentInfo" />
                                                <asp:BoundField DataField="OS_Name" HeaderText="Other Speciality" SortExpression="OS_Name" />
                                               <%-- <asp:BoundField DataField="SubService_Name" HeaderText="Sub Service" SortExpression="SubService_Name" />--%>
                                                <%--<asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description" />--%>
                                                <asp:TemplateField HeaderText="View File">
                                                    <ItemTemplate>
                                                        <a id="afile" href='<%# Eval("Img_path") %>' target="_blank" runat="server" tooltip="View File" class="fa fa-image"></a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <div class="btn-group">
                                                            <asp:LinkButton ID="lnk_UP" CausesValidation="false" ToolTip="Page Up"
                                                                CommandArgument='<%# Eval("Equipment_id") + "," + Eval("Equipment_level_id") + ","+ "up"%>' runat="server" data-original-title="Page Up" CssClass="btn btn-sm show-tooltip">
                                                            <i class="fa fa-arrow-circle-up"></i>
                                                            </asp:LinkButton>

                                                            <asp:LinkButton ID="lnk_Dwn" CausesValidation="false" ToolTip="Page Down"
                                                                CommandArgument='<%# Eval("Equipment_id") + "," + Eval("Equipment_level_id") + "," +   "down" %>'
                                        ...
                                        <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                            SelectCommand="[PROC_EquipmentMasterdetails_Search]" SelectCommandType="StoredProcedure" FilterExpression="Staffname like '%{0}%' OR Designation like '%{0}%' OR OS_Name like '%{0}%' ">
                                            <FilterParameters>
                                                <asp:ControlParameter ControlID="txtSearch" Name="Staffname" />
                                                <asp:ControlParameter ControlID="txtSearch" Name="Designation" />
                                                <asp:ControlParameter ControlID="txtSearch" Name="OS_Name" />
                                            </FilterParameters>
                                        </asp:SqlDataSource>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="ddlOtherSpeciality">Other Speciality Master Name</label>
                                        <asp:DropDownList ID="ddlOtherSpeciality" CssClass="form-control" runat="server">
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="rfvDepartment" InitialValue="-1" ForeColor="Red" runat="server" ControlToValidate="ddlOtherSpeciality"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtStaffname" TabIndex="1" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvStaffname" CssClass="validationmsg" runat="server" ControlToValidate="txtStaffname"
                                            ErrorMessage="Please enter staff name." SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Designation Details*<span class="req-field">*</span></label>
                                        <asp:TextBox ID="txtDesignation" TabIndex="1" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvDesignation" CssClass="validationmsg" runat="server" ControlToValidate="txtDesignation"
                                            ErrorMessage="Please enter Equipment Info." SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <a  onclick="return RemoveImage('bodyPart_lblfilename','bodyPart_aRemovefilename','bodyPart_hffilename');" class="fa fa-trash-o btn btn-primary"  id="aRemovefilename" runat="server" style="margin-left:5px;">Remove</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
