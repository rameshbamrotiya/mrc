...
{
    public partial class MedicalTourismFacilitiesMaster : System.Web.UI.Page
    {
        #region Page Load
        ...
        protected void gView_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if ((e.CommandName.Equals("eView")) || (e.CommandName.Equals("eEdit")) || (e.CommandName.Equals("eDelete")))
                {
                    ...
                    Int32 bytID;
                    bytID = Convert.ToInt32(gView.DataKeys[intIndex].Values["MTF_id"]);
                    if (e.CommandName == "eDelete")
                    {
                        MedicalTourismFacilitiesBO objBo = new MedicalTourismFacilitiesBO();
                        objBo.MTF_id = bytID;
                        new MedicalTourismBAL().DeleteFacilitiesRecord(objBo);
                        BindGridView();
        ...
        private bool FillControls(Int32 iPkId, int languageId)
        {
            ...
            DataSet ds = new MedicalTourismBAL().SelectFacilitiesRecord(objBo);
            ...
            if (dr["Description"] != DBNull.Value)
                txtaccdesc.Text = HttpUtility.HtmlDecode(dr["Description"].ToString());
            ...
            {
                hfMainImage.Value = dr["Doc_path"].ToString();
                lblMainImage.Text = dr["Doc_path"].ToString();
        ...
        private void LoadControls(MedicalTourismFacilitiesBO objBo)
        {
            ...
            {
                objBo.Doc_path = hfMainImage.Value.ToString();
            }
            objBo.Name = txtAccName.Text;
            objBo.Description = HttpUtility.HtmlEncode(txtaccdesc.Text);
        ...
        protected void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                MedicalTourismFacilitiesBO objBo = new MedicalTourismFacilitiesBO();
                LoadControls(objBo);
                if (new MedicalTourismBAL().InsertFacilitiesRecord(objBo))
                {
                    hfMainImage.Value = "";
                    lblMainImage.Text = "";
                    aRemoveMain.Visible = false;
        ...
        protected void btn_Update_Click(object sender, EventArgs e)
        {
            try
            {
                MedicalTourismFacilitiesBO objBo = new MedicalTourismFacilitiesBO();
                LoadControls(objBo);
                objBo.MTF_id = Convert.ToInt32(ViewState["PK"]);
                if (new MedicalTourismBAL().UpdateFacilitiesRecord(objBo))
                {
                    hfMainImage.Value = "";
                    lblMainImage.Text = "";
                    aRemoveMain.Visible = false;
