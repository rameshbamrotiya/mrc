<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="PackageType.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.CMS.PackageType" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
      <title>CMS | Package Type</title>
</asp:Content>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlLanguage" CssClass="form-control" runat="server" AutoPostBack="true" ValidationGroup="Profile" OnSelectedIndexChanged="ddlLanguage_SelectedIndexChanged">
                            </asp:DropDownList>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <label for="txtPackageType">Package Type Name</label>
                            <asp:TextBox ID="txtPackageType" aria-describedby="emailHelp" CssClass="form-control" placeholder="Enter Package Type name" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvPackageType" ForeColor="Red" runat="server" ControlToValidate="txtPackageType"
                                ErrorMessage="Enter Package Type." SetFocusOnError="true"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <label>&nbsp;</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                SelectCommand="GetAlltbl_Package_Type_Master" SelectCommandType="StoredProcedure" FilterExpression="PackageType like '%{0}%' ">
                                <FilterParameters>
