<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="StarOfTheWeekMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.CMS.StarOfTheWeekMaster" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Star Of The Week/Month Master</title>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="page_header" runat="server">
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
            <h4>StarOfTheWeek/Month Master</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">CMS</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">StarOfTheWeek/Month Master</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-left: 10px;">
                                    <div class="form-group">
                                        <asp:GridView ID="gView" runat="server" AutoGenerateColumns="False" DataKeyNames="S_id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                            DataSourceID="sqlds" AllowPaging="true" AllowSorting="true" OnRowCommand="gView_RowCommand" PageSize="10">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="StarOfThe" HeaderText="Star Of The Week/Month" SortExpression="StarOfThe" />
                                                <asp:TemplateField HeaderText="View File">
                                                    <ItemTemplate>
                                                        <a id="afile" href='<%# Eval("Imgpath") %>' target="_blank" runat="server" tooltip="View File" class="fa fa-picture-o"></a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <div class="btn-group">
                                                            ...
                                                            <% if (SessionWrapper.UserPageDetails.CanDelete)
                                                                { %>
                                                            <asp:LinkButton ID="ibtn_Delete" ToolTip="Delete" CommandName="eDelete" OnClientClick='<%# Eval("Metatitle", "return confirm(\"Are you sure want to delete : {0} ? \")") %>' runat="server" SkinID="lDelete" data-original-title="Delete" CssClass="btn btn-sm btn-danger show-tooltip"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                            <%} %>
                                                        </div>
                                                    </ItemTemplate>
                                        ...
                                        <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                            SelectCommand="[PROC_StarOfTheWeekMasterdetails_Search]" SelectCommandType="StoredProcedure" FilterExpression="Metatitle like '%{0}%' ">
                                            <FilterParameters>
                                                <asp:ControlParameter ControlID="txtSearch" Name="Metatitle" />
                                            </FilterParameters>
                                        </asp:SqlDataSource>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvMetaTitle" ForeColor="Red" runat="server" ControlToValidate="txtMetaTitle" Display="Dynamic" ValidationGroup="main"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ForeColor="Red" runat="server" ControlToValidate="txtMetaDescription" Display="Dynamic" ValidationGroup="main"
                                            ErrorMessage="Enter Meta Description." SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div id="week" class="row" runat="server">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                ...
                                <%--<div id="date" class="row" runat="server">--%>
                                <%--    <div id="datefrom" runat="server" class="col-md-4">
                                        <div class="form-group">
                                            <label for="txtFromDate">From Date</label>
                                            <asp:TextBox autocomplete="off" ID="txtFromDate" aria-describedby="emailHelp" CssClass="form-control pull-right dtpicker" placeholder="Enter From Date" runat="server"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rfvfromdate" ForeColor="Red" runat="server" ControlToValidate="txtFromDate" Display="Dynamic" ValidationGroup="main"
                                                ErrorMessage="Select From date." SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div id="dateto" runat="server" class="col-md-4">
                                        <div class="form-group">
                                            <label for="txtToDate">To Date</label>
                                            <asp:TextBox autocomplete="off" ID="txtToDate" aria-describedby="emailHelp" CssClass="form-control pull-right dtpicker" placeholder="Enter To Date" runat="server"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rfvtodate" ForeColor="Red" runat="server" ControlToValidate="txtToDate" Display="Dynamic" ValidationGroup="main"
                                                ErrorMessage="Select To date." SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>--%>
                                
                                <div id="month" class="row" runat="server">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="txtFirstName">Month</label>
                                            <asp:DropDownList ID="ddlMonth" class=" form-control" runat="server" ValidationGroup="Main">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RadioButtonList ID="rblstar"  AutoPostBack="true" runat="server" CssClass="form-control" RepeatDirection="Horizontal">
                                            <asp:ListItem Value="Week" Text="Week"></asp:ListItem>
                                            <asp:ListItem Value="Month" Text="Month"></asp:ListItem>
                                        </asp:RadioButtonList>
                                        <asp:RequiredFieldValidator ID="rfvGender" InitialValue="" ForeColor="Red" runat="server" ControlToValidate="rblstar"
                                            ErrorMessage="Select Star Of the?." SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="txtShortDescription">Upload Image</label>
...
<%--    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $j('#<%=txtFromDate.ClientID%>').datepicker({
                changeMonth: true,
                changeYear: true,
                format: "dd/MM/yyyy",
                language: "tr"
            ...
            $j('#<%=txtToDate.ClientID%>').datepicker({
                changeMonth: true,
                changeYear: true,
                format: "dd/MM/yyyy",
                language: "tr"
