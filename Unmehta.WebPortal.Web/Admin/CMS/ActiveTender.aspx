<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ActiveTender.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.CMS.ActiveTender" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Active Tender</title>
</asp:Content>
        ...
        <div class="container-fluid d-sm-flex justify-content-between">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Active Tender</li>
                </ol>
            </nav>
        </div>
    </div>
                            ...
                            <div class="pull-right">
                                <div class="input-group">
                                    <% if (SessionWrapper.UserPageDetails.CanAdd)
                                        { %>
                                    <button runat="server" id="btn_Inactive" class="btn btn-primary" title="Move To Inactive" onserverclick="btn_Inactive_Click" causesvalidation="false">
                                        Move To Inactive
                                    </button>
                                    <%} %>
                                </div>
                            ...
                            <div class="form-group">
                                <asp:GridView ID="gView" runat="server" AutoGenerateColumns="False" DataKeyNames="TenderID" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="In Active">
                                            <HeaderTemplate>
                                                <p>In Active</p>
                                ...
                                <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                    SelectCommand="PROC_GILTender_TenderMaster_Search" SelectCommandType="StoredProcedure" FilterExpression="Title like '%{0}%' ">
                                    <FilterParameters>
