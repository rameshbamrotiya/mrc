<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ArticleDepartmentMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.CMS.ArticleDepartmentMaster" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="page_header" runat="server">
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
            <h4>Article Department Master</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">CMS</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Artsicle Department Master</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-left: 10px;">
                                    <div class="form-group">
                                        <asp:GridView ID="gView" runat="server" AutoGenerateColumns="False" DataKeyNames="AD_id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="AD_Name" HeaderText="Articles Department Name" SortExpression="AD_Name" />
                                                <asp:BoundField DataField="AD_Title" HeaderText="Articles Department Title" SortExpression="AD_Title" />
                                                    ...
                                                    <ItemTemplate>
                                                        <div class="btn-group">
                                                            ...
                                                            <% if (SessionWrapper.UserPageDetails.CanDelete)
                                                                { %>
                                                            <asp:LinkButton ID="ibtn_Delete" ToolTip="Delete" CommandName="eDelete" OnClientClick='<%# Eval("AD_Name", "return confirm(\"Are you sure want to delete : {0} ? \")") %>' runat="server" SkinID="lDelete" data-original-title="Delete" CssClass="btn btn-sm btn-danger show-tooltip"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                            <%} %>
                                                        </div>
                                                    </ItemTemplate>
                                        ...
                                        <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                            SelectCommand="[PROC_ArticlesDepartmentMasterdetails_Search]" SelectCommandType="StoredProcedure" FilterExpression="AD_Name like '%{0}%' ">
                                            <FilterParameters>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Article Department Name<span class="req-field">*</span></label>
                                        <asp:TextBox autocomplete="off" ID="txtArticleDepartment" TabIndex="1" MaxLength="500" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvSpecialityName" CssClass="validationmsg" runat="server" ControlToValidate="txtArticleDepartment"
                                            ErrorMessage="Please enter Articles Department Name." SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Article Department Title<span class="req-field">*</span></label>
                                        <asp:TextBox autocomplete="off" ID="txtArticleDepTitle" TextMode="MultiLine" TabIndex="1" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" CssClass="validationmsg" runat="server" ControlToValidate="txtArticleDepTitle"
                                            ErrorMessage="Please enter Articles Department Title." SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                        </div>
