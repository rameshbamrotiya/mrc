<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CommitteeMaster.aspx.cs" ValidateRequest="false" Inherits="Unmehta.WebPortal.Web.Admin.CMS.CommitteeMaster" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Committee Master</title>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="page_header" runat="server">
    ...
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
            <h4>Committee Master</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">CMS</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Committee Master</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Committee Description</label>
                                ...
                                <div class="col-md-12">
                                     <asp:GridView ID="gvDoc" runat="server" AutoGenerateColumns="False" OnRowDeleting="gvDoc_RowDeleting" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                        AllowPaging="true" PageSize="10" OnPageIndexChanging="gvDoc_PageIndexChanging">
                                        <Columns>
