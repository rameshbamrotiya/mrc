        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!Page.IsPostBack)
                {
                    ...
                    FillControls("COMMITTEE", Convert.ToInt32(ddlLanguage.SelectedValue));
                    //ViewState["TmpDocument"] = null;
                }
            }
            catch (Exception ex)
            ...
            if (ViewState["TmpDocument"] != null)
            {
                ...
                if (fuDocUpload.HasFile)
                {
                    ...
                    if (!string.IsNullOrEmpty(filepath) && !isError)
                    {
                        ...
                        ErrorLogger.ERROR("Committee", filepath, this);
                        ...
                        BindGrid();
                        ErrorLogger.ERROR("Committee Done", filepath, this);
                    }
                    else
                    {
                        return;
                ...
                else
                {
                    Functions.MessagePopup(this, "Please Select File.", PopupMessageType.error);
                        ErrorLogger.ERROR("Committee", "Please Select File.", this);
                }
