<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="VisionMissionMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.VisionMissionMaster" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Vision Mission Master</title>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="page_header" runat="server">
    ...
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
            <h4>Vision Mission Master</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">CMS</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Vision Mission Master</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="txtVisionMissionName">Vision Mission Description<span class="req-field">*</span></label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <asp:FileUpload ID="fuImageUpload" class="form-control" runat="server" />
                            <asp:Image ID="imgProfile" Height="100px" Width="100px" Visible="false" runat="server" ValidationGroup="Profile" />
                            <p class="help-block">( Image should be 600px*360px )</p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <br />
                        <asp:Button runat="server" ID="btnAddDoctor" CssClass="btn btn-primary " Text="Add To Image List" OnClick="btnAddDoctor_Click" Style="margin-top: 7px;" />
                    </div>
                        ...
                        <div class="form-group">
                            <asp:GridView ID="gvDoctor" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ImageName" HeaderText="Doctor Name" SortExpression="DoctorName" />
                        ...
                        <div class="form-group">
                            <asp:GridView ID="grdUser" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Descr" HeaderText="Vision Mission Description" SortExpression="Descr" />
