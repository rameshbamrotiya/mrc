<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="MedicalTourismFacilitiesMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.CMS.MedicalTourismFacilitiesMaster" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>MedicalTourismFacilities Master</title>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="page_header" runat="server">
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
            <h4>Medical Tourism Facilities</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">CMS</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Medical Tourism Facilities</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-left: 10px;">
                                    <div class="form-group">
                                        <asp:GridView ID="gView" runat="server" AutoGenerateColumns="False" DataKeyNames="MTF_id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="View File">
                                                    <ItemTemplate>
                                                        <a id="afile" href='<%# Eval("Doc_path") %>' target="_blank" runat="server" tooltip="View File" class="fa fa-picture-o"></a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                        ...
                                        <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                            SelectCommand="[PROC_MedicalTourismFacilitiesMasterdetails_Search]" SelectCommandType="StoredProcedure" FilterExpression="Name like '%{0}%' ">
                                            <FilterParameters>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox autocomplete="off" ID="txtAccName" TabIndex="1" MaxLength="50" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvDocName" CssClass="validationmsg" runat="server" ControlToValidate="txtAccName"
                                ...
                                <%--<div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtaccdesc" autocomplete="off" TextMode="MultiLine" TabIndex="1" MaxLength="50" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" CssClass="validationmsg" runat="server" ControlToValidate="txtaccdesc"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Description<span class="req-field">*</span></label>
                                        <asp:TextBox ID="txtaccdesc" TextMode="MultiLine" runat="server" CssClass="form-control"></asp:TextBox>
                                        <script type="text/javascript">
                                         ...
                                         <%--<asp:RequiredFieldValidator ID="rfvdesc" CssClass="validationmsg" runat="server" ControlToValidate="txtaccdesc"
                                            ErrorMessage="Please enter description." SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                                    </div>
                                </div>
                            </div>
