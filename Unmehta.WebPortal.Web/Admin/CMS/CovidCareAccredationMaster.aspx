<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CovidCareAccredationMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.CMS.CovidCareAccredationMaster" ValidateRequest="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="page_header" runat="server">
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
            <h4>Covid Care Accredation Master</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">CMS</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Covid Care Accredation Master</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group" style="overflow-x: scroll;">
                            <asp:GridView ID="gView" runat="server" AutoGenerateColumns="False" DataKeyNames="Accredation_Id,CovidCareDetails_Id,Language_id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                AllowSorting="false" OnPageIndexChanging="gView_PageIndexChanging" PageSize="10" OnRowCommand="gView_RowCommand" AllowPaging="true">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="AccredationSubTitle" HeaderText="Accredation Title" />
                                    <asp:TemplateField HeaderText="Sequencing">
                                        <ItemTemplate>
                                            <div class="btn-group">
                                                <asp:LinkButton ID="lnk_UP" CausesValidation="false" ToolTip="Page Up"
                                                    CommandArgument='<%# Eval("Accredation_Id") + "," + Eval("Accredation_level_id") + ","+ "up"%>' runat="server" data-original-title="Page Up" CssClass="btn btn-sm show-tooltip">
                                                            <i class="fa fa-arrow-circle-up"></i>
                                                </asp:LinkButton>

                                                <asp:LinkButton ID="lnk_Dwn" CausesValidation="false" ToolTip="Page Down"
                                                    CommandArgument='<%# Eval("Accredation_Id") + "," + Eval("Accredation_level_id") + "," +   "down" %>'
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            <div class="btn-group">
                                                ...
                                                <asp:LinkButton ID="ibtn_Delete" CommandName="eDelete" runat="server" SkinID="lDelete" CausesValidation="false" OnClick="ibtn_Delete_Click" OnClientClick='<%# Eval("AccredationSubTitle", "return confirm(\"Are you sure want to delete : {0} ? \")") %>' data-original-title="Delete" CssClass="btn btn-sm btn-danger show-tooltip"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
