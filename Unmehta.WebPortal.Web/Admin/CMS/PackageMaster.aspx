<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="PackageMaster.aspx.cs" ValidateRequest="false" Inherits="Unmehta.WebPortal.Web.Admin.CMS.PackageMaster" %>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-left: 10px;">
                                    <div class="form-group">
                                        <asp:GridView ID="gView" runat="server" AutoGenerateColumns="False" DataKeyNames="Package_id,Package_level_id,id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                                    ...
                                                    <ItemTemplate>
                                                        <div class="btn-group">
                                                            <asp:LinkButton ID="lnk_UP" CausesValidation="false" ToolTip="Page Up"
                                                                CommandArgument='<%# Eval("Package_id") + "," + Eval("Package_level_id") + ","+ "up"%>' runat="server" data-original-title="Page Up" CssClass="btn btn-sm show-tooltip">
                                                            <i class="fa fa-arrow-circle-up"></i>
                                                            </asp:LinkButton>
                                                            <asp:LinkButton ID="lnk_Dwn" CausesValidation="false" ToolTip="Page Down"
                                                                CommandArgument='<%# Eval("Package_id") + "," + Eval("Package_level_id") + "," +   "down" %>'
                                        ...
                                        <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                            SelectCommand="[PROC_PackageMasterdetails_Search]" SelectCommandType="StoredProcedure" FilterExpression="Title like '%{0}%' ">
                                            <FilterParameters>
                ...
                <asp:Panel ID="pnlEntry" runat="server">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <asp:HiddenField ID="hfSubPackageDetailsId" Value="0" runat="server" />
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlActiveInactive" CssClass="form-control" TabIndex="2" runat="server" Style="width: 100%">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtsequence" TabIndex="3" MaxLength="50" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="exampleInputFile">Title<span class="req-field">*</span></label>
                                <asp:TextBox ID="txtSubTitle" TabIndex="6" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="exampleInputFile">Price<span class="req-field">*</span></label>
                                <asp:TextBox ID="txtPrice" TabIndex="7" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="ddl">Package Type</label>
                                <asp:DropDownList ID="ddlPackageType" CssClass="form-control" runat="server" TabIndex="8">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="rfvAccredationYear" InitialValue="-1" ForeColor="Red" runat="server" ControlToValidate="ddlPackageType"
                                    ErrorMessage="Select Package Type." SetFocusOnError="true"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="exampleInputFile">Description<span class="req-field">*</span></label>
                                <asp:TextBox ID="txtDescription" TextMode="MultiLine" runat="server" CssClass="form-control" TabIndex="9"></asp:TextBox>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="exampleInputFile">Status<span class="req-field">*</span></label>
                                <asp:DropDownList ID="ddlStatus" CssClass="form-control" TabIndex="10" runat="server" Style="width: 100%">
                        ...
                        <div class="col-md-3">
                            <label>&nbsp;</label>
                            <div class="form-group">
                                <button class="fa fa-plus-circle btn btn-primary" tabindex="11" data-toggle="tooltip" style="cursor: pointer;" title="Add" id="btnSubDetailsAdd" runat="server" onserverclick="btnSubDetailsAdd_ServerClick" causesvalidation="false" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group" style="overflow-x: scroll;">
                                <asp:GridView ID="subgridView" runat="server" AutoGenerateColumns="False" DataKeyNames="Id,PackageId" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Package_SubMaster_level_id" HeaderText="Sequence No" SortExpression="Package_SubMaster_level_id" />
                                        <asp:TemplateField HeaderText="Sequencing">
                                            <ItemTemplate>
                                                <div class="btn-group">
                                                    <asp:LinkButton ID="lnk_UP" CausesValidation="false" ToolTip="Page Up"
                                                        CommandArgument='<%# Eval("PackageId") + "," + Eval("Package_SubMaster_level_id") + ","+ "up"%>' runat="server" data-original-title="Page Up" CssClass="btn btn-sm show-tooltip">
                                                            <i class="fa fa-arrow-circle-up"></i>
                                                    </asp:LinkButton>

                                                    <asp:LinkButton ID="lnk_Dwn" CausesValidation="false" ToolTip="Page Down"
                                                        CommandArgument='<%# Eval("PackageId") + "," + Eval("Package_SubMaster_level_id") + "," +   "down" %>'
                                                        runat="server" data-original-title="Page Down" CssClass="btn btn-sm show-tooltip">
                                                            <i class="fa fa-arrow-circle-down"></i>
                                                    </asp:LinkButton>
                                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 BtnGrp">
                            <div class="form-group">
                                <button runat="server" id="btnFinalSave" class="btn btn-primary" tabindex="12" title="Save" onserverclick="btnFinalSave_ServerClick">
                                    <i class="fa fa-floppy-o">&nbsp;Final Save</i>
                                </button>
                                <button runat="server" id="btn_Update" class="btn btn-primary" tabindex="13" title="Update" onserverclick="btn_Update_Click">
                                    <i class="fa fa-floppy-o">&nbsp;Update</i>
                                </button>
                                <button runat="server" id="Button1" class="btn btn-inverse" title="Cancel" tabindex="14" onserverclick="Button1_ServerClick" causesvalidation="false">
                                    <i class="fa fa-remove">&nbsp;Cancel</i>
                                </button>
                            </div>
                        </div>
