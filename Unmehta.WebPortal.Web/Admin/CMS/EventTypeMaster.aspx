<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EventTypeMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.CMS.EventTypeMaster" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>EventType Master</title>
</asp:Content>
                                ...
                                <div class="col-md-12" style="margin-left: 10px;">
                                    <div class="form-group">
                                        ...
                                        <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                            SelectCommand="[EventTypeMaster_Search]" SelectCommandType="StoredProcedure" FilterExpression="EventName like '%{0}%' ">
                                            <FilterParameters>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtEventName" TabIndex="1" TextMode="MultiLine" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvDocName" CssClass="validationmsg" runat="server" ControlToValidate="txtEventName"
                                            ErrorMessage="Please enter EventName." SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                        </div>
