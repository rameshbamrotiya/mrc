<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="VideocategoryMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.CMS.VideocategoryMaster" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="page_header" runat="server">
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
            <h4>Video Album Master</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">CMS</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Video Album Master</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="exampleInputFile">Video Album Name<span class="req-field">*</span></label>
                            <asp:TextBox ID="txtVideoCategoryname" MaxLength="50" runat="server" CssClass="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvBlockName" CssClass="validationmsg" runat="server" ControlToValidate="txtVideoCategoryname"
                                ErrorMessage="Enter VideoCategory Name" SetFocusOnError="true"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div>
                            <div class="form-group">
                                ...
                                <label visible="true" style="font-weight: normal;" id="Thumbnillpath" runat="server"></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtTagList" runat="server" CssClass="form-control" TabIndex="13"></asp:TextBox>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" DataSourceID="sqlds" CssClass="table table-bordered table-hover table-striped" DataKeyNames="VCID,Id,LanguageID" EmptyDataText="Record does not exist..."
                                AllowSorting="false">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="VideoCategoryName" HeaderText="Video Album Name" ItemStyle-Font-Bold="true" />
                                    <asp:TemplateField HeaderText="View Album Thumbnail">
                                        <ItemTemplate>
                                            <a id="Thumbnailfile" href='<%# Eval("ThumbnillPath") %>' target="_blank" runat="server" tooltip="View Thumbnail" class="fa fa-picture-o"></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            <div class="btn-group">
                                                ...
                                                <asp:LinkButton ID="ibtn_Delete" OnClick="ibtn_Delete_Click" ToolTip="Delete" CommandName="eDelete" OnClientClick='<%# Eval("VideoCategoryName", "return confirm(\"Are you sure want to delete : {0} ? \")") %>' runat="server" SkinID="lDelete" data-original-title="Delete" CssClass="btn btn-sm btn-danger show-tooltip"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
                            ...
                            <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                SelectCommand="[GetAllVideocategoryDetails]" SelectCommandType="StoredProcedure" FilterExpression="VideoCategoryName like '%{0}%' ">
                                <FilterParameters>
                                    <asp:ControlParameter ControlID="txtSearch" Name="VideoCategoryName" />
