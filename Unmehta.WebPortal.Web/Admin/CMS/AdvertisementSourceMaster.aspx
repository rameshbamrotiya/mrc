<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AdvertisementSourceMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.CMS.AdvertisementSourceMaster" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>AdvertisementSource Master</title>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="page_header" runat="server">
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
            <h4>AdvertisementSource Master</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">CMS</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">AdvertisementSource Master</li>
                </ol>
            </nav>
        </div>
    </div>
                                    ...
                                    <div class="form-group">
                                        <asp:GridView ID="gView" runat="server" AutoGenerateColumns="False" DataKeyNames="id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Advertisement_Name" HeaderText="Advertisement Name" SortExpression="Advertisement_Name" />
                                                    ...
                                                    <ItemTemplate>
                                                        <div class="btn-group">
                                                            ...
                                                            <% if (SessionWrapper.UserPageDetails.CanDelete)
                                                                { %>
                                                            <asp:LinkButton ID="ibtn_Delete" ToolTip="Delete" CommandName="eDelete" OnClientClick='<%# Eval("Advertisement_Name", "return confirm(\"Are you sure want to delete : {0} ? \")") %>' runat="server" SkinID="lDelete" data-original-title="Delete" CssClass="btn btn-sm btn-danger show-tooltip"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                            <%} %>
                                                        </div>
                                                    </ItemTemplate>
                                        ...
                                        <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                            SelectCommand="[PROC_AdvertisementSourceMasterdetails_Search]" SelectCommandType="StoredProcedure" FilterExpression="Advertisement_Name like '%{0}%' ">
                                            <FilterParameters>
                                                <asp:ControlParameter ControlID="txtSearch" Name="Advertisement_Name" />
                                            </FilterParameters>
                                        </asp:SqlDataSource>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Advertisement Name<span class="req-field">*</span></label>
                                        <asp:TextBox autocomplete="off" ID="txtAdvertisementName" TabIndex="1" MaxLength="50" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvAdvertisementName" CssClass="validationmsg" runat="server" ControlToValidate="txtAdvertisementName"
