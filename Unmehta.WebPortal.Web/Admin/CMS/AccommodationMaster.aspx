<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AccommodationMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.CMS.AccommodationMaster" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Accommodation Master</title>
</asp:Content>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-left: 10px;">
                                    <div class="form-group">
                                        <asp:GridView ID="gView" runat="server" AutoGenerateColumns="False" DataKeyNames="Acc_id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                        ...
                                        <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                            SelectCommand="[PROC_AccommodationMasterdetails_Search]" SelectCommandType="StoredProcedure" FilterExpression="Name like '%{0}%' ">
                                            <FilterParameters>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox autocomplete="off" ID="txtAccName" TabIndex="2"  MaxLength="50" runat="server" CssClass="form-control"></asp:TextBox>
                                ...
                                <div class="col-md-6">
                                    <div runat="server">
                                        <div class="form-group">
                                            ...
                                            <asp:FileUpload accept=".png,.jpg,.jpeg,.pdf" ID="fuDocUpload" runat="server" TabIndex="3" CssClass="form-control" />
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtaccdesc" autocomplete="off" TextMode="MultiLine" TabIndex="5" MaxLength="50" runat="server" CssClass="form-control"></asp:TextBox>
