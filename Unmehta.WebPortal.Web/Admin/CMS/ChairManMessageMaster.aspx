<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ChairManMessageMaster.aspx.cs" ValidateRequest="false" Inherits="Unmehta.WebPortal.Web.Admin.CMS.ChairManMessageMaster" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="page_header" runat="server">
    <div class="page-header">
        <div class="container-fluid d-sm-flex justify-content-between">
            <h4>ChairManMessage</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">CMS</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">ChairManMessage</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <asp:GridView ID="gvDetail" runat="server" AutoGenerateColumns="False" DataKeyNames="CMId" DataSourceID="SqlDataSource1"
                                            ...
                                            <ItemTemplate>
                                                <div class="btn-group">
                                                    ...
                                                    <%}
                                                        ...
                                                        { %>
                                                    <asp:LinkButton ID="ibtn_Remove" CommandName="eDelete" runat="server" data-original-title="Remove" OnClientClick='<%# Eval("CMId", "return confirm(\"Are you sure want to delete ? \")") %>' CssClass="btn btn-sm show-tooltip"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                    <%} %>
                                                </div>
                                            </ItemTemplate>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>" SelectCommand="GetAllChairManMessageMasterSearch" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                            </div>
                        </div>
                    </div>
                </asp:Panel>
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <asp:View ID="View1" runat="server">
                                        ...
                                        <asp:HiddenField ID="hfCMId" Value="0" runat="server" />
                                        <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group">
                                                        <asp:CheckBox ID="cbEnable" runat="server" Text="Enable" />
                                                    </div>
