<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="WetreatMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.Hospital.WetrateMaster" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Wetreat Master</title>
</asp:Content>
        ...
        <div class="container-fluid d-sm-flex justify-content-between">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Wetreat</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-left: 10px;">
                                    <div class="form-group">
                                        <asp:GridView ID="gView" runat="server" AutoGenerateColumns="False" DataKeyNames="W_id" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="WetreatDesc" HeaderText="Wetreat Description" SortExpression="Wetreat Description" />
                                                    ...
                                                    <ItemTemplate>
                                                        <div class="btn-group">
                                                            ...
                                                            <%-- <%}
                                                                ...
                                                                { %>--%>
                                                            <asp:LinkButton ID="ibtn_Delete" ToolTip="Delete" CommandName="eDelete" OnClientClick='<%# Eval("WetreatDesc", "return confirm(\"Are you sure want to delete : {0} ? \")") %>' runat="server" SkinID="lDelete" data-original-title="Delete" CssClass="btn btn-sm btn-danger show-tooltip"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                            <%--<%} %>--%>
                                                        </div>
                                                    </ItemTemplate>
                                        ...
                                        <asp:SqlDataSource ID="sqlds" runat="server" ConnectionString="<%$ ConnectionStrings:UNMehtaConnectionString %>"
                                            SelectCommand="[PROC_WetreatMasterdetails_Search]" SelectCommandType="StoredProcedure" FilterExpression="WetreatDesc like '%{0}%' ">
                                            <FilterParameters>
                                                <asp:ControlParameter ControlID="txtSearch" Name="WetreatDesc" />
                                            </FilterParameters>
                                        </asp:SqlDataSource>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Wetreat Description<span class="req-field">*</span></label>
                                        <asp:TextBox ID="txtWdesc" autocomplete="off" TextMode="MultiLine" TabIndex="1" MaxLength="50" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" CssClass="validationmsg" runat="server" ControlToValidate="txtWdesc"
                                ...
                                <div class="col-md-5">
                                    <div runat="server">
                                        <div class="form-group">
                                            ...
                                            <asp:FileUpload accept=".png,.jpg,.jpeg,.pdf" ID="fuDocUpload" runat="server" TabIndex="2" CssClass="form-control" />
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Read More<span class="req-field">*</span></label>
                                        <asp:DropDownList ID="ddlreadmore" CssClass="form-control" AutoPostBack="true" TabIndex="3" runat="server" OnSelectedIndexChanged="ddlreadmore_SelectedIndexChanged" Style="width: 100%">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="exampleInputFile">We-treat pop-up Description<span class="req-field">*</span></label>
                                        <asp:TextBox ID="txtWetreatpopupdesc" TextMode="MultiLine" runat="server" CssClass="form-control"></asp:TextBox>
                                        <script type="text/javascript">
                                            CKEDITOR.dtd.$removeEmpty['i'] = false;
                                            var editor = CKEDITOR.replace('<%=txtWetreatpopupdesc.ClientID%>', {
