<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OtherFacilitiesMaster.aspx.cs" Inherits="Unmehta.WebPortal.Web.Admin.Hospital.OtherFacilitiesMaster" ValidateRequest="false" %>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="exampleInputFile">Side Image <span class="req-field">*</span></label>
                        <asp:FileUpload accept=".png,.jpg,.jpeg,.gif" ID="fuSideImage" runat="server" TabIndex="2" CssClass="form-control" ValidationGroup="main" />
                        <asp:Label ID="lblSideImage" runat="server" Text="" ValidationGroup="main"></asp:Label>
                        <asp:HiddenField ID="hfSideImage" runat="server" />
                        <a onclick="return RemoveImage('bodyPart_lblSideImage','bodyPart_aRemoveSideImage','bodyPart_hfSideImage');" id="aRemoveSideImage" class="fa fa-trash-o btn btn-primary"  runat="server" style="margin-left: 5px;">Remove</a>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtExternalVideoLink" runat="server" CssClass="form-control" placeholder="Enter External Video Link" ValidationGroup="main"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-4">
                    <label>&nbsp;</label>
            ...
            <div class="row" id="dvSubDetails" runat="server">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="exampleInputFile">Sub Title<span class="req-field">*</span></label>
                        <asp:TextBox ID="txtSubTitle" runat="server" CssClass="form-control" ValidationGroup="Sub"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvSubTitle" CssClass="validationmsg" runat="server" ControlToValidate="txtSubTitle" ValidationGroup="Sub"
                            ErrorMessage="Enter Sub Title." SetFocusOnError="true"></asp:RequiredFieldValidator>
                    </div>
                </div>

                <div class="col-md-12">
                    <div class="form-group">
                        <label for="exampleInputFile">Sub Description<span class="req-field"></span></label>
                        <asp:TextBox ID="txtSubDescription" runat="server" Rows="10" TextMode="MultiLine" ValidationGroup="Sub"></asp:TextBox>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <asp:GridView ID="gvSubDetails" runat="server" AutoGenerateColumns="False" DataKeyNames="Id,OurFacillityId" CssClass="table table-bordered table-hover table-striped" EmptyDataText="Record does not exist..."
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Title" HeaderText="Support Service" />
