<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ParaMedical.aspx.cs" Inherits="Unmehta.WebPortal.Web.ParaMedical" %>
    ...
    <div class="page-title">
        ...
        <div class="container-fluid">
            <ul class="page-breadcrumb">
                ...
                <li>/</li>
                <li><a href="<%=ResolveUrl("~/AcademicParaMedical") %>">Academic Para Medical</a></li>
                <li>/</li>
                <li><a>Academic Para Medical Detail</a></li>
            </ul>
        </div>
    </div>
    <div class="content">
                    ...
                    <div class="sidebar">
                        <div class="card widget-categories">
                            <div class="card-header">
                                <h4 class="card-title">Para Medical</h4>
                            </div>
                            <div class="card-body">
                                <ul class="categories">
                                    <%=strCourseList %>
