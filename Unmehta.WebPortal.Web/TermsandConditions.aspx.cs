    ...
    public partial class TermsandConditions : System.Web.UI.Page
    {
        ...
        private string GetPageData()
        {
            ...
            else
            {
                ...
                DataSet ds = new TCBAL().SelectRecord(objbo);
                LableData:
                if (ds != null)
                {
                    ...
                    else
                    {
                        if (Functions.LanguageId != 1 && languageId != 1)
                        {
                            languageId = 1;
                        objbo.LanguageId = languageId;
                        ds = new TCBAL().SelectRecord(objbo);
                            goto LableData;
                        }
                    }
                }
        ...
        private string GetHeaderImage()
        {
            ...
            {
                var dataMain = objBlogCategoryMasterRepository.GetBreadCumImageByPageName(languageId, "TermsandConditions").FirstOrDefault();
                ...
                if (dataMain != null)
                {
                    ...
                    {
                        languageId = 1;
                        dataMain = objBlogCategoryMasterRepository.GetBreadCumImageByPageName(languageId, "TermsandConditions").FirstOrDefault();
                        if (languageId != 1)
                        {
                            goto LableData;
                        }
