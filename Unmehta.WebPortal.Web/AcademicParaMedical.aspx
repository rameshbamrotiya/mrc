<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AcademicParaMedical.aspx.cs" Inherits="Unmehta.WebPortal.Web.AcademicParaMedical" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Academic Para Medical
</asp:Content>
    ...
    <div class="page-title">
        ...
        <div class="container-fluid">
            <ul class="page-breadcrumb">
                ...
                <li>/</li>
                <li><a href="#">Academic Para Medical</a></li>
            </ul>
        </div>
