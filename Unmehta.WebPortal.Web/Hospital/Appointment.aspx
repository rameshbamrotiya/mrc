<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital/Hospital.Master" AutoEventWireup="true" CodeBehind="Appointment.aspx.cs" Inherits="Unmehta.WebPortal.Web.Hospital.Appointment" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <label>&nbsp;</label>
                                    <a class=' btn btn-block btn-primary bookAppointment' id='#bookApp' data-original-title='' data-original-name=''>Book Appointment</a>
                                </div>
    ...
    <script>
        ...
        function GetPageEvent() {
            ...
            $(".bookAppointment").click(function () {
                ...
                var ddlSpecialization = $("#<%=ddlSpecialization.ClientID %>").val();
                var ddlUnit = $("#<%=ddlUnit.ClientID %>").val();
                debugger
                if (!(ddlSpecialization != null && ddlSpecialization != undefined && ddlSpecialization != "" && ddlSpecialization != "Select Specialization" && ddlSpecialization != "Select")) {
                    TosterMessage("Select Specialization", "error");
                    return false;
                }
                if (!(ddlUnit != null && ddlUnit != undefined && ddlUnit != "" && ddlUnit != "0")) {
                    TosterMessage("Select Unit", "error");
                    return false;
                }
