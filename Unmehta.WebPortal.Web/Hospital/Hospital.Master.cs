...
namespace Unmehta.WebPortal.Web.Hospital
{
    public partial class Hospital : System.Web.UI.MasterPage
    {
        ...
        private void BindHeaderFooter()
        {
            using (IHomePageRepository objData = new HomePageRepository(Functions.strSqlConnectionString))
            {
                ...
                if (data != null)
                {
                    ...
                    if (!string.IsNullOrWhiteSpace((data.HeaderLogo)))
                    {
                        ...
                        strFooterLogo = "https://www.unmicrc.org/"+strURLs;
                    }
                    ...
                    if (!string.IsNullOrWhiteSpace((data.HeaderLogo)))
                    {
                        ...
                        strURLs = ResolveUrl("~/" + strURLs);
                        strHeaderLogo = "https://www.unmicrc.org/" + strURLs;
                    }
                }
            }
                    ...
                    foreach (var item in data)
                    {
                        ...
                        if (!string.IsNullOrWhiteSpace(item.InternalLink))
                        {
                            if (item.InternalOrExternal == "Internal")
                            {
                                ...
                                strURLs = "https://www.unmicrc.org/" + ResolveUrl( strURLs);
                            }
                            else
                            {
            ...
            {
                string strImage = "https://www.unmicrc.org/" + ResolveUrl( row["ImgLogo"].ToString());
