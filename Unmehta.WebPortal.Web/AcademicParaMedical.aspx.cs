...
{
    public partial class AcademicParaMedical : System.Web.UI.Page
    {
        ...
        private string GetTabDetailList(string strSearch = "")
        {
            ...
            using (StudentCourseBAL objStudentAdvertisementBAL = new StudentCourseBAL())
            {
                ...
                if (dataOfUserName != null)
                {
                    ...
                    foreach (var dataRom in data.Where(x=> x.IsVisible==true).ToList())
                    {
        ...
        private string GetParaMedicalDescription()
        {
            ...
            if (ds != null)
            {
                if (!ds.Tables.Count.Equals(0) && !ds.Tables[0].Rows.Count.Equals(0))
                {
                    ...
                    {
                        strParaMedicalMainDescriptionCKeditor.Append(HttpUtility.HtmlDecode(row["ParamedicalInnerDescription"].ToString()));
                        i++;
                    }
                }
            }
        ...
        private string GetHeaderImage()
        {
            ...
            {
                var dataMain = objBlogCategoryMasterRepository.GetBreadCumImageByPageName(languageId, "AcademicParaMedical").FirstOrDefault();
                ...
                if (dataMain != null)
                {
                    ...
                    {
                        languageId = 1;
                        dataMain = objBlogCategoryMasterRepository.GetBreadCumImageByPageName(languageId, "AcademicParaMedical").FirstOrDefault();
                        if (languageId != 1)
                        {
                            goto LableData;
                        }
