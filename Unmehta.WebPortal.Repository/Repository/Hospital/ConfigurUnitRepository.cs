...
{
    public class ConfigurUnitRepository : IConfigurUnitRepository
    {
        private string SqlConnectionSTring;
        public ConfigurUnitRepository(string strConnection)
        {
        ...
        public List<GetAllUnitMasterResult> GetAllConfigUnit()
        {
            using (UnitMasterDataContext db = new UnitMasterDataContext(SqlConnectionSTring))
            {//tbl_ConfigUnit
                return db.GetAllUnitMaster().ToList();
        ...
        public UnitTeamModel GetUnitByLangId(long lgId, long lgLangId)
        {
         ...
         public bool InsertOrUpdateConfigUnit(UnitTeamModel objData, out string strError)
        {
